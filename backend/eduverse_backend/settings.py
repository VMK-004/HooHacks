"""
Django settings for eduverse_backend project.
...
SECRET_KEY = 'django-insecure-vd(nyu_b$gekaow9#@gyv&@9wuj(mb_v+b7z!%3xe+a%4nhm)u'
...
WSGI_APPLICATION = 'eduverse_backend.wsgi.application'
